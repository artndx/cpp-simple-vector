...
inline void Test2() {
    // PushBack
    {
        ...
        assert(v[0] == 0);
        assert(v[1] == 42);
        std::cout << "PushBack1 test completed\n";
    }
    ...
    // Если хватает места, PushBack не увеличивает Capacity
    {
        ...
        assert(v.GetSize() == 2);
        assert(v.GetCapacity() == old_capacity);
        std::cout << "PushBack2 test completed\n";
    }
    ...
    // PopBack
    {
        ...
        std::cout << "PopBack test completed\n";
    }
    ...
    // Конструктор копирования
    {
        ...
        std::cout << "CopyConstructor test completed\n";
    }
    ...
    // Присваивание
    {
        ...
        std::cout << "Assignment test completed\n";
    }
